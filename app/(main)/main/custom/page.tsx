  ...
  <div className="fixed inset-0 z-50 flex items-center justify-center">
    ...
    <div className="relative bg-white rounded-2xl p-6 z-10 shadow-xl flex flex-col items-center gap-4 min-w-[320px]">
      ...
      <form onSubmit={handleSubmit} className="flex-1 px-4 space-y-6">
        ...
        <button
          type="submit"
          className="w-full py-4 bg-blue-600 text-white text-lg font-semibold rounded-xl mt-8 hover:bg-blue-700 transition-colors disabled:opacity-50 mb-3 shadow-lg"
        >
          Start Chatting
        </button>
      </form>
