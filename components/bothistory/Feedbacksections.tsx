  ...
  <div className="w-full h-2 bg-blue-100 rounded-full">
    ...
    ></div>
      ...
      <div className='flex items-center justify-center gap-4 mt-[34px]'>
        <button onClick={viewfeedback} className='px-4 min-w-[120px] h-9 text-white bg-blue-600 rounded-[8px] cursor-pointer'>
          View Feedback
        </button>
        <button onClick={() => handleDeleteChat(id)} className='px-4 min-w-[80px] h-9 text-white bg-gray-300 rounded-[8px] cursor-pointer'>
          Delete
        </button>
      </div>
    </div>
