    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="px-4 pt-4 pb-3 border-b border-gray-200 bg-white">
        <div className="flex items-center justify-between">
          <h1 className="text-gray-900 text-xl font-semibold font-pretendard">Profile</h1>
        </div>
      </div>
        ...
        <div className="flex-1 relative h-full w-[375px]">
          ...
          <div className="px-4 pt-6">
            <div className="flex flex-col items-center">
              <div className="relative mb-4">
                {profile.profileImageUrl.startsWith('http') ? (
                  ...
                  (() => {
                    ...
                    return (
                      <Face className="w-32 h-32 rounded-full bg-gray-100 p-4" />
                    );
                  })()
                )}
              </div>
              <Link
                href="/profile/edit"
                className="inline-flex items-center space-x-2 text-gray-900 text-xl font-semibold font-pretendard leading-[130%] hover:text-gray-700 transition-colors"
              >
          ...
          <div className="px-4 pt-6 pb-6">
            <button
              ...
              className="w-full py-4 text-gray-600 text-base font-medium font-pretendard leading-[130%] underline hover:text-gray-800 transition-colors"
            >
              Log out
            </button>
          </div>
